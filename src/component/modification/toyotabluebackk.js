...
function Model(props) {
    const { scene } = useGLTF("/toyotabluebackk.glb");
    return <primitive object={scene} scale={0.010} {...props} />;
}

const Toyotabluebackk = () => {
    return (
        <>
            <Canvas dpr={[1, 2]}  camera={{ fov: 45 }} style={{ "position": "absolute", "bottom": "220px", "align-items": "center" }}>
...
export default Toyotabluebackk;
